    ...
    return (
      <div className="flex h-screen items-center justify-center bg-background">
        <div className="flex flex-col items-center gap-4 p-4 text-center">
          ...
          <p className="text-muted-foreground">Loading application, please wait...</p>
          <div role="status" aria-live="polite" className="mt-4">
            <svg aria-hidden="true" className="inline w-8 h-8 text-primary animate-spin fill-secondary" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
